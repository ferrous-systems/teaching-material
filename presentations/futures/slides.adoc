...
The crate https://github.com/alexcrichton/futures-rs[`futures-rs`] is commonly used to build asyncronous functionality. It provides constructs similar to ``Promise``s in Javascript.
...
`futures-rs` comes with https://docs.rs/futures-cpupool/0.1.7/futures_cpupool/[`futures_cpupool`] which provides a simple, easy to use CPU Pool type.
