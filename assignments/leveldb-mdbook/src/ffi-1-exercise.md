...
Writing a sys crate yourself is beyond the scope of this exercise. We will be using the [`leveldb-sys` crate provided for you](https://docs.rs/leveldb-sys/2.0.9/leveldb_sys).
